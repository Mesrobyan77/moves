  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto z-[100]">
      <div className="relative flex items-center group">
        <FiSearch
          className={`absolute left-4 transition-colors ${searchError ? "text-red-500" : "text-muted group-focus-within:text-primary"}`}
        />
        <input
          type="text"
          value={query}
            ...
            {searchError ? (
              ...
              <div className="text-center py-12">
                <p className="text-sm text-muted">
                  ...
                  <span className="text-foreground italic">{query}</span>
                </p>
              </div>
            )}
          </div>
