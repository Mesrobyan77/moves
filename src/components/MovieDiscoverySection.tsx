...
const MovieDiscoverySection = ({
  upcomingMovies,
}: MovieDiscoverySectionProps) => {
  return (
          ...
          <div className="flex-1">
            ...
            <div className="space-y-6">
              {[1, 2].map((_, i) => (
                <div
                  key={i}
                  className="bg-card/50 backdrop-blur-sm p-6 rounded-2xl border border-border hover:border-primary/20 transition-all group"
                >
