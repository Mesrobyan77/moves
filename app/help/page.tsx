    ...
    <main className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <section className="container mx-auto px-4 pt-16 pb-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-border pb-10">
          <h1 className="text-5xl font-bebas tracking-tight uppercase">{t('help.title')}</h1>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bebas mb-12 text-center tracking-wide uppercase">{t('help.faq_title')}</h2>
...
function HelpCard({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
  return (
    <div className="bg-card p-10 rounded-3xl border border-border hover:border-primary/30 transition-all group text-center shadow-sm">
      ...
      <h3 className="text-xl font-bebas tracking-wide mb-4 text-foreground uppercase">{title}</h3>
